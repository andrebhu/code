...
public class TreePart
{
   ...
   private int leafColor;           //0-YELLOW, 1-ORANGE, 2-RED, 3-BROWN, otherwise GREEN
...
*/
   public TreePart(int newX, int newY, Color newColor, double deg, double degChange, double dist, double distChange, double w, double wChange, int gen, int lColor)
   {
      x=newX;
      y=newY;
      color=newColor;
...
*/
   public TreePart(int newX, int newY, Color newColor, double deg, double degChange, double dist, double distChange, double w, double wChange, int gen, int lColor, TreePart newParent)
   {
      ...
      if(leafColor == 0)   //YELLOW
      {
         ...
         if(leafColor == 1)   //ORANGE
         {
            ...
            if(leafColor == 2)   //RED
            {
               ...
               if(leafColor == 3)   //BROWN
               {
                  r = (int)(Math.random() * 56) + 100;
                  g = (int)(Math.random() * 56) + 75;
                  b = (int)(Math.random() * 56) + 25;
               }
               else //GREEN
               {
